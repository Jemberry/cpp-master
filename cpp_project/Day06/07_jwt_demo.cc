...
int main()
{
    ...
    const char* token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3ODA1NzkzMDksInJvbGUiOiJhZG1pbiIsInN1YiI6InN1YmplY3QiLCJ1C2VybmFtZSI6InBlYW51dGl4eCJ9.il8NjdzzpoyDoatpJsCHyJkYD51FNkvZus795TqXp1KY";
